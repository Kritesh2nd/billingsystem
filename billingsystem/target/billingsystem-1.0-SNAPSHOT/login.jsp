...
<html>
  <head>
    <title>Billing System | Log In</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="css/style.css">
    <style>
      .mainbody{height:100vh;}
      .box1{font-size:34px;text-align: center;padding:20px;}
      .box2{flex-grow: 1;}
  ...
  <body>
    <div class="mainbody flex fdc">
      <div class="box1 borde">
          Customer Billing Sytsem
      </div>
      <div class="box2 borde flex aic jcc">
        <%
          if(showlogin==true){
        %>
        <form action="login.jsp" method="POST" class="form border">
          <div class="formtitle">Log In</div>
          <div class="formtxt1 formtxt0">Email</div>
          <input type="text" class="inpbox1 inpbox0 border" name="email">
          <div class="formtxt2 formtxt0">Password</div>
          <input type="password" class="inpbox2 inpbox0 border"name="password">
          ...
          <div class="btnbox2 borde flex">
            <a href="register.jsp" class="ahrlink registerbtn border w100">
              Register
            </a>
          </div>
        ...
        %>
        <form action="login.jsp?forgetpw=true" method="POST" class="form border">
          <div class="formtitle">Forget password</div>
          <div class="formtxt1 formtxt0 f2txt1">Email</div>
          <input type="text" class="inpbox1 inpbox0 border" name="newemail">
          <div class="formtxt2 formtxt0 f2txt2">New Password</div>
          <input type="text" class="inpbox2 inpbox0 border" name="newpassword">
          ...
          <div class="btnbox2 borde flex">
            <a href="login.jsp" class="ahrlink registerbtn border w100">Log In</a>
          </div>
        </form>
        <%}%>
      </div>
